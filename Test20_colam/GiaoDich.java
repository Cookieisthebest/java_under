...
//        //sap xep theo ma 
//        //tang dan
//        //return getMa().toUpperCase().compareTo(t.getMa().toUpperCase());
//        //giam dan
//        //return t.getMa().toUpperCase().compareTo(getMa().toUpperCase());
//        //tang dan theo gia
//        //return Double.compare(getGia(), t.getGia());
//        //giam dan theo so luong
//        return t.getSoluong()-getSoluong();
//    }
